...
class LatestApprovalTestCase(TestCase):
    ...
    def test_block_new_approval_during_waiting_period(self):
        user = user_with_approval_in_waiting_period()
        ...
        assert user.block_new_approval_during_waiting_period(
        ...
        assert not user.block_new_approval_during_waiting_period(
            siae=CompanyFactory(kind=CompanyKind.ETTI),
