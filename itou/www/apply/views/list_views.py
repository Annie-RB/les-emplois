...
def list_for_prescriptions(request, template_name="apply/list_for_prescriptions.html"):
    """
...
@login_required
@user_passes_test(lambda u: u.is_prescriber, login_url=reverse_lazy("search:employers_home"), redirect_field_name=None)
def list_for_prescriptions_exports(request, template_name="apply/list_of_available_exports.html"):
    """
...
@login_required
@user_passes_test(lambda u: u.is_prescriber, login_url=reverse_lazy("search:employers_home"), redirect_field_name=None)
def list_for_prescriptions_exports_download(request, month_identifier=None):
    """
